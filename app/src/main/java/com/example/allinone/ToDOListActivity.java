...
public class ToDOListActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemLongClickListener {
    private EditText ed;
    ...
    public void onClick(View view) {
        ...
        {
            values.add(add_item);
            adapter=new ArrayAdapter<String>(ToDOListActivity.this,android.R.layout.simple_list_item_1,values);
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ToDOListActivity.this); // Ask the user to get the confirmation before deleting an item from the listView
